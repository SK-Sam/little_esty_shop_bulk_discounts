...
RSpec.describe Customer, type: :model do
  ...
  describe 'class methods' do
    it '::top_customers' do
      expected = [@customer_1, @customer_2, @customer_3, @customer_4, @customer_6]
  ...
  describe 'instance methods' do
    it '#number_of_transactions' do
      ...
      expect(@customer_2.number_of_transactions).to eq(1)
      expect(@customer_3.number_of_transactions).to eq(1)
    end
  end
end
